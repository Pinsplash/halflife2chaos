...
static ConVar sv_lagcompensation_teleport_dist("sv_lagcompensation_teleport_dist", "64", FCVAR_NONE, "How far a player got moved by game code before we can't lag compensate their position back");
...
ConVar sv_showlagcompensation("sv_showlagcompensation", "0", FCVAR_NONE, "Show lag compensated hitboxes whenever a player is lag compensated.");
