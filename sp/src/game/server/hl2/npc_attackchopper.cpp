...
{
	//Msg("CNPC_AttackHelicopter::StopLoopingSounds\n");
...
{
	//Msg("CNPC_AttackHelicopter::Precache\n");
	BaseClass::Precache();
...
{
	//Msg("CNPC_AttackHelicopter::ObjectCaps");
...
{
	//Msg("CNPC_AttackHelicopter::InputOutsideTransition\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputSetOutsideTransitionTarget\n");
...
{
	//Msg("CNPC_AttackHelicopter::CreateComponents\n");
...
{
	//Msg("CNPC_AttackHelicopter::Spawn\n");
	Precache( );
...
{
	//Msg("CNPC_AttackHelicopter::Startup\n");
	BaseClass::Startup();
...
{
	//Msg("CNPC_AttackHelicopter::BlinkLightsThink\n");
	bool bIsOn = false;
	for ( int i = 0; i < MAX_HELICOPTER_LIGHTS; ++i )
	{
		if ( !m_hLights[i] )
...
{
	//Msg("CNPC_AttackHelicopter::SpotlightStartup\n");
	if ( !HasSpawnFlags( SF_HELICOPTER_LIGHTS ) )
		return;
...
{
	//Msg("CNPC_AttackHelicopter::SpotlightShutdown\n");
...
{
	//Msg("CNPC_AttackHelicopter::SpotlightThink\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputEnableAlwaysTransition\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputDisableAlwaysTransition\n");
...
{
	//Msg("CNPC_AttackHelicopter::UpdateOnRemove\n");
...
{
	//Msg("CNPC_AttackHelicopter::Activate\n");
	BaseClass::Activate();
...
{
	//Msg("CNPC_AttackHelicopter::GetTracerType\n");
...
{
	//Msg("CNPC_AttackHelicopter::DoImpactEffect\n");
...
{
	//Msg("CNPC_AttackHelicopter::InitializeRotorSound\n");
	if ( !m_pRotorSound )
	{
		CSoundEnvelopeController &controller = CSoundEnvelopeController::GetController();
...
{
	//Msg("CNPC_AttackHelicopter::GetMaxSpeed\n");
	if ( HasSpawnFlags(SF_HELICOPTER_ELECTRICAL_DRONE) )
		return DRONE_SPEED;
...
{
	//Msg("CNPC_AttackHelicopter::GetMaxSpeedFiring\n");
	if ( HasSpawnFlags(SF_HELICOPTER_ELECTRICAL_DRONE) )
		return DRONE_SPEED;
...
{
	//Msg("CNPC_AttackHelicopter::GetMaxFiringDistance\n");
	if ( !GetEnemyVehicle() )
...
{
	//Msg("CNPC_AttackHelicopter::EnemySearchDistance\n");
	return 6000.0f;
}
...
{
	//Msg("CNPC_AttackHelicopter::InputStartBombingVehicle\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputStartTrailingVehicle\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputStartDefaultBehavior\n");
	m_nAttackMode = ATTACK_MODE_DEFAULT;
}

void CNPC_AttackHelicopter::InputStartAlwaysLeadingVehicle( inputdata_t &inputdata )
{
	//Msg("CNPC_AttackHelicopter::InputStartAlwaysLeadingVehicle\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputStartBullrushBehavior\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputStartCarpetBombing\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputStopCarpetBombing\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputBecomeIndestructible\n");
...
{
	//Msg("CNPC_AttackHelicopter::IsDeadlyShooting\n");
...
{
	//Msg("CNPC_AttackHelicopter::GetShootingMode\n");
	if ( IsDeadlyShooting() )
...
{
	//Msg("CNPC_AttackHelicopter::InputEnableBombing\n");
	m_bBombingSuppressed = false;
}

void CNPC_AttackHelicopter::InputDisableBombing( inputdata_t &inputdata )
{
	//Msg("CNPC_AttackHelicopter::InputDisableBombing\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputDisablePathVisibilityTests\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputEnablePathVisibilityTests\n");
	m_bIgnorePathVisibilityTests = false;
...
{
	//Msg("CNPC_AttackHelicopter::InputSelfDestruct\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputSetHealthFraction\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputStartBombExplodeOnContact\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputStopBombExplodeOnContact\n");
	m_bBombsExplodeOnContact = false;
}
...
{
	//Msg("CNPC_AttackHelicopter::InputResetIdleTime\n");
...
{
	//Msg("CNPC_AttackHelicopter::FindTrackBlocker\n");
...
{
	//Msg("CNPC_AttackHelicopter::FVisible\n");
...
{
	//Msg("CNPC_AttackHelicopter::GetAttackSpread\n");
...
{
	//Msg("CNPC_AttackHelicopter::BuildMissTargetList\n");
...
{
	//Msg("CNPC_AttackHelicopter::GetEnemyVehicle\n");
	if ( !GetEnemy() )
		return NULL;
...
{
	//Msg("CNPC_AttackHelicopter::ShootAtPlayer\n");
...
{
	//Msg("CNPC_AttackHelicopter::PickDirectionToCircleOfDeath\n");
...
{
	//Msg("CNPC_AttackHelicopter::AimCloseToTargetButMiss\n");
	Vector vecDirection;
...
{
	//Msg("CNPC_AttackHelicopter::FireBullets\n");
...
{
	//Msg("CNPC_AttackHelicopter::ShootInsideCircleOfDeath\n");
...
{
	//Msg("CNPC_AttackHelicopter::DoMuzzleFlash\n");
...
{
	//Msg("CNPC_AttackHelicopter::ShootAtVehicle\n");
...
{
	//Msg("CNPC_AttackHelicopter::PoseGunTowardTargetDirection\n");
	Vector vecOut;
...
{
	//Msg("CNPC_AttackHelicopter::ComputeFireAtPosition\n");
...
{
	//Msg("CNPC_AttackHelicopter::ComputeVehicleFireAtPosition\n");
...
{
	//Msg("CNPC_AttackHelicopter::DoGunIdle\n");
...
{
	//Msg("CNPC_AttackHelicopter::UpdateTargetHittability\n");
...
{
	//Msg("CNPC_AttackHelicopter::DoGunCharging\n");
...
{
	//Msg("CNPC_AttackHelicopter::ShootAtFacingDirection\n");
	// Just shoot where we're facing
	float flSinConeDegrees = sin( sk_helicopter_firingcone.GetFloat() * 0.5f * (3.14f / 180.0f) );
	Vector vecSpread( flSinConeDegrees, flSinConeDegrees, flSinConeDegrees );
...
{
	//Msg("CNPC_AttackHelicopter::IsValidZapTarget\n");
...
{
	//Msg("CNPC_AttackHelicopter::CreateZapBeam\n");
	CEffectData	data;
	data.m_nEntIndex = entindex();
...
{
	//Msg("CNPC_AttackHelicopter::CreateEntityZapEffect\n");
	CEffectData	data;
...
{
	//Msg("CNPC_AttackHelicopter::FireElectricityGun\n");
	if ( m_flNextAttack > gpGlobals->curtime )
		return;
...
{
	//Msg("CNPC_AttackHelicopter::DoGunFiring\n");
	CSoundEnvelopeController &controller = CSoundEnvelopeController::GetController();
...
{
	//Msg("CNPC_AttackHelicopter::IsBombDropFair\n");
	if ( (m_nAttackMode == ATTACK_MODE_BULLRUSH_VEHICLE) && IsInSecondaryMode( BULLRUSH_MODE_SHOOT_IDLE_PLAYER ) )
		return true;
...
{
	//Msg("CNPC_AttackHelicopter::SpawnBombEntity\n");
...
{
	//Msg("CNPC_AttackHelicopter::CreateBomb\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputDropBomb\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputDropBombStraightDown\n");
	if ( m_flInputDropBombTime > gpGlobals->curtime )
		return;
...
{
	//Msg("CNPC_AttackHelicopter::InputDropBombAtTargetInternal\n");
	if ( m_flInputDropBombTime > gpGlobals->curtime )
		return;
...
{
	//Msg("CNPC_AttackHelicopter::InputDropBombAtTargetAlways\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputDropBombAtTarget\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputDropBombDelay\n");
...
{
	//Msg("CNPC_AttackHelicopter::DropBombs\n");
	// Can't continually fire....
	if (m_flNextAttack > gpGlobals->curtime)
		return;
...
{
	//Msg("CNPC_AttackHelicopter::ShouldDropBombs\n");
	if ( IsCarpetBombing() )
		return true;
...
{
	//Msg("CNPC_AttackHelicopter::BullrushBombs\n");
...
{
	//Msg("CNPC_AttackHelicopter::InputGunOff\n");
...
{
	//Msg("CNPC_AttackHelicopter::FireGun\n");
...
{
	//Msg("CNPC_AttackHelicopter::ShouldTriggerDamageEffect\n");
...
{
	//Msg("CNPC_AttackHelicopter::AddSmokeTrail\n");
...
{
	//Msg("CNPC_AttackHelicopter::DestroySmokeTrails\n");
...
{
	//Msg("CNPC_AttackHelicopter::ExplodeAndThrowChunk\n");
	CEffectData data;
...
{
	//Msg("CNPC_AttackHelicopter::DropCorpse\n");
...
{
	//Msg("CNPC_AttackHelicopter::TraceAttack\n");
...
{
	//Msg("CNPC_AttackHelicopter::OnTakeDamage\n");
...
{
	//Msg("CNPC_AttackHelicopter::OnTakeDamage_Alive\n");
...
{
	//Msg("CNPC_AttackHelicopter::Event_Killed\n");
	if( m_lifeState == LIFE_ALIVE )
	{
...
{
	//Msg("CNPC_AttackHelicopter::CreateChopperHusk\n");
...
{
	//Msg("CNPC_AttackHelicopter::PrescheduleThink\n");
...
{
	//Msg("CNPC_AttackHelicopter::UpdatePerpPathDistance\n");
...
{
	//Msg("CNPC_AttackHelicopter::GetMaxSpeedAndAccel\n");
...
{
	//Msg("CNPC_AttackHelicopter::ComputeVelocity\n");
	Vector deltaPos;
...
{
	//Msg("CNPC_AttackHelicopter::ComputeAngularVelocity\n");
	QAngle goalAngAccel;
	if ( m_lifeState != LIFE_DYING || (m_lifeState == LIFE_DYING && GetCrashPoint() != NULL) )
	{
		Vector forward, right, up;
...
{
	//Msg("CNPC_AttackHelicopter::FlightDirectlyOverhead\n");
...
{
	//Msg("CNPC_AttackHelicopter::Flight\n");
...
{
	//Msg("CNPC_AttackHelicopter::UpdateFacingDirection\n");
...
{
	//Msg("CNPC_AttackHelicopter::CreepTowardEnemy\n");
...
{
	//Msg("CNPC_AttackHelicopter::ComputeBombingLeadingDistance\n");
...
{
	//Msg("CNPC_AttackHelicopter::ComputeBullrushLeadingDistance\n");
	switch ( m_nSecondaryMode )
	{
...
{
	//Msg("CNPC_AttackHelicopter::SetSecondaryMode\n");
...
{
	//Msg("CNPC_AttackHelicopter::SwitchToBullrushIdle\n");
...
{
	//Msg("CNPC_AttackHelicopter::ShouldShootIdlePlayerInBullrush\n");
...
{
	//Msg("CNPC_AttackHelicopter::ShutdownGunDuringBullrush\n");
	// Put us directly into idle gun state (we're in firing state)
	m_flNextAttack = gpGlobals->curtime;
	m_nGunState = GUN_STATE_IDLE;
	m_nRemainingBursts = 0;
...
{
	//Msg("CNPC_AttackHelicopter::ShouldBombIdlePlayer\n");
...
{
	//Msg("CNPC_AttackHelicopter::UpdateBullrushState\n");
...
{
	//Msg("CNPC_AttackHelicopter::UpdateEnemyLeading\n");
...
{
	////Msg("CNPC_AttackHelicopter::SetTransmit\n");
...
{
	//Msg("CNPC_AttackHelicopter::Hunt\n");
...
{
	//Msg("CNPC_AttackHelicopter::PopulatePoseParameters\n");
