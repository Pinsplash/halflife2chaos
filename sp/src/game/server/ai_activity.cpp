...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_MELEE_ATTACK_SKEWER );
	...
	ADD_ACTIVITY_TO_SR( ACT_IDLE_HARPOON );
	ADD_ACTIVITY_TO_SR( ACT_WALK_HARPOON );
	...
	ADD_ACTIVITY_TO_SR( ACT_IDLE_ANGRY_HARPOON );
	...
	ADD_ACTIVITY_TO_SR( ACT_RUN_HARPOON );
