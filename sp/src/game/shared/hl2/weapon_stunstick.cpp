...
#else
class CWeaponStunStick : public C_BaseHLBludgeonWeapon
#endif
{
#ifndef CLIENT_DLL
	DECLARE_CLASS(CWeaponStunStick, CBaseHLBludgeonWeapon);
#else
	DECLARE_CLASS(CWeaponStunStick, C_BaseHLBludgeonWeapon);
#endif
	...
	switch( pEvent->event )
	{
		case EVENT_WEAPON_MELEE_HIT:
		{
			...
			CBaseEntity *pHurt = pOperator->CheckTraceHullAttack( pOperator->Weapon_ShootPosition(), vecEnd, 
				Vector(-16,-16,-40), Vector(16,16,16), GetDamageForActivity( GetActivity() ), GetDamageType(), 0.5f, false );
