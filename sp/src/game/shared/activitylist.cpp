...
//===========================
	...
	REGISTER_SHARED_ACTIVITY( ACT_MELEE_ATTACK_SKEWER );
	...
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_HARPOON );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_HARPOON );
	...
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_ANGRY_HARPOON );
	...
	REGISTER_SHARED_ACTIVITY( ACT_RUN_HARPOON );
