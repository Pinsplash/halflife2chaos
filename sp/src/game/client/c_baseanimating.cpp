...
ConVar vcollide_wireframe("vcollide_wireframe", "0", FCVAR_NONE, "Render physics collision models in wireframe", VCollideWireframe_ChangeCallback);
...
ConVar g_debug_ragdoll_visualize("g_debug_ragdoll_visualize", "0", FCVAR_NONE);
