...
static ConVar cam_command("cam_command", "0", FCVAR_NONE);	 // tells camera to go to thirdperson
...
static ConVar cam_showangles("cam_showangles", "0", FCVAR_NONE, "When in thirdperson, print viewangles/idealangles/cameraoffsets to the console.");
...
static ConCommand thirdperson_mayamode("thirdperson_mayamode", ::CAM_ToThirdPerson_MayaMode, "Switch to thirdperson Maya-like camera controls.", FCVAR_NONE);
...
#else
static ConCommand thirdperson("thirdperson", ::CAM_ToThirdPerson, "Switch to thirdperson camera.", FCVAR_NONE);
static ConCommand firstperson( "firstperson", ::CAM_ToFirstPerson, "Switch to firstperson camera." );
#endif
static ConCommand camortho("camortho", ::CAM_ToOrthographic, "Switch to orthographic camera.", FCVAR_NONE);
static ConCommand camnormal("camnormal", ::CAM_ToNormal, "Switch to normal camera.", FCVAR_NONE);
