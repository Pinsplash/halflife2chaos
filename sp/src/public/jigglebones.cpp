...
#ifdef CLIENT_DLL
//-----------------------------------------------------------------------------
ConVar cl_jiggle_bone_debug("cl_jiggle_bone_debug", "0", FCVAR_NONE, "Display physics-based 'jiggle bone' debugging information");
ConVar cl_jiggle_bone_debug_yaw_constraints("cl_jiggle_bone_debug_yaw_constraints", "0", FCVAR_NONE, "Display physics-based 'jiggle bone' debugging information");
ConVar cl_jiggle_bone_debug_pitch_constraints("cl_jiggle_bone_debug_pitch_constraints", "0", FCVAR_NONE, "Display physics-based 'jiggle bone' debugging information");
#endif // CLIENT_DLL
